...
async fn locale_map() {
    ...
    use recoyx_localization::date_time_format::mock::MockDateTime;
    println!("{}", locale_map.create_date_time_formatter(&Default::default()).format(&MockDateTime::try_new(2020, 9, 1, 12, 34, 28).unwrap()));
}